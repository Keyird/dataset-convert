...
if __name__ == '__main__':
    ...
    json_files = sorted(glob.glob(os.path.join("D:\\Project\\yolov4\\FLIR\\", '*.json')))
            ...
            for i in range(0, len(images)):
                ...
                for ann in annotations:
                    if ann['image_id'] == i and ann['category_id'] <= 3:
                        ...
                        cat_id -= 1  # Yolo classes are starting from zero index
                ...
                file = open("D:\\Project\\yolov4\\FLIR\\yolo\\" + str(image_name) + '.txt', 'w+')
